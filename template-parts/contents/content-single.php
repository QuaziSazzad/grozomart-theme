	...
	<?php if (('yes' === $show_tag && has_tag()) || 'yes' === $show_post_share) : ?>
		<div class="row tag-share-wrap mt-5 mb-5">
			<?php if ('yes' === $show_tag && has_tag()) : ?>
				<div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay=".2s">
					<div class="tagcloud">
			...
			<?php endif; ?>
			<?php if ('yes' === $show_post_share) : ?>
				<div class="col-lg-6 col-12 mt-3 mt-lg-0 text-lg-end wow fadeInUp" data-wow-delay=".4s">
